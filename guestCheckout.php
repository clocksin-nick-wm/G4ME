...
//        $varapt = $_POST['apt'];
    ...
    $stmt = $dbh->prepare("INSERT INTO users (firstName, lastName, email, address, city, state, country, apt, payType, payment, securityCode) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");

    $result = $stmt->execute(array($_POST['fName'], $_POST['lName'], $_POST['email'], $_POST['address'], $_POST['city'], $_POST['state'], $_POST['country'], $_POST['apt'], $_POST['payType'], $_POST['payment'], $_POST['securityCode']));
...
<form id="info" action="guestCheckout.php" method="post" role="form">
    ...
    <div class="form-group">
        ...
        <select name="payType" id="paymentType" form="info" action="guestCheckout.php">
    ...
    <div class="form-group">
        <label>Security Code</label><input type="number" size="3" name="securityCode" maxlength="4" placeholder="xxx">
    </div>
