    ...
    <div class="content">
        ...
        <div class="product-items">
            ...
            <div class="product-item">
                ...
                <div class="item-info">
                    <div class="item-title">Fallout 4</div>
                    <p style="text-decoration: line-through; color: red">$59.99</p>
                    <p style="color: darkred">97% OFF</p>
                    <div class="item-price" data-price="1.79">$1.79</div>
                </div>
            </div>
            <!-- end item -->
            <div class="product-item">
                <div class="item-wrap">
                    <img src="Games/Rise-Of-The-Tomb-Raider.jpg">
                    <div class="wrap-qtt">
                        <div class="wrap-qtt-field-qtt">
                            <input class="field-qtt" name="qtt" value="1" readonly=""/>
                        </div>
                ...
                <div class="item-info">
                    <div class="item-title">Rise of the Tomb Raider</div>
                    <p style="text-decoration: line-through; color: red">$59.99</p>
                    <p style="color: darkred">50% OFF</p>
                    <div class="item-price" data-price="29.99">$29.99</div>
                </div>
            </div>
            <div class="product-item">
                <div class="item-wrap">
                    <img src="Games/Witness.jpg">
                    <div class="wrap-qtt">
                        <div class="wrap-qtt-field-qtt">
                            <input class="field-qtt" name="qtt" value="1" readonly=""/>
                        </div>
                ...
                <div class="item-info">
                    <div class="item-title">Witness</div>
                    <p style="text-decoration: line-through; color: red">$39.99</p>
                    <p style="color: darkred">45% OFF</p>
                    <div class="item-price" data-price="25.99">$25.99</div>
                </div>
            </div>
            <div class="product-items">
                <!-- start item -->
                <div class="product-item">
                    <div class="item-wrap">
                        <img src="Games/Assassins%20Creed.jpg">
                        <div class="wrap-qtt">
                            <div class="wrap-qtt-field-qtt">
                                <input class="field-qtt" name="qtt" value="1" readonly=""/>
                            </div>
                    ...
                    <div class="item-info">
                        <div class="item-title">Assassin's Creed <br> Syndicate</div>
                        <p style="text-decoration: line-through; color: red">$59.99</p>
                        <p style="color: darkred">35% OFF</p>
                        <div class="item-price" data-price="38.99">$38.99</div>
                    </div>
                </div>
                <!-- end item -->
                <div class="product-item">
                    <div class="item-wrap">
                        <img src="Games/The%20Division.jpg">
                        <div class="wrap-qtt">
                            <div class="wrap-qtt-field-qtt">
                                <input class="field-qtt" name="qtt" value="1" readonly=""/>
                            </div>
                    ...
                    <div class="item-info">
                        <div class="item-title">The Division</div>
                        <p style="text-decoration: line-through; color: red">$59.99</p>
                        <p style="color: darkred">75% OFF</p>
                        <div class="item-price" data-price="19.99">$19.99</div>
                    </div>
                </div>
                <div class="product-item">
                    <div class="item-wrap">
