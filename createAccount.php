...
<html>
<head>
    <title>G4Me create account</title>
...
<?php
//PDO section designed for creating an account
...
<nav class="navbar navbar-inverse">
    <div class="container-fluid">
        ...
        <ul class="nav navbar-nav">
            ...
            <li><a href="#">About Us/Contact</a></li>4
            <li><a href="#">Games</a></li>
            <li><a href="#">Sales</a></li>
        </ul>
        <ul class="nav navbar-nav navbar-right">
            <li><a href="g4me.php"><span class="glyphicon glyphicon-shopping-cart"></span>Cart</a> </li>
